...
export default function Summary() {
  ...
  return (
    <div className="grid grid-cols-2">
      ...
      >
        <div className="opacity-50 text-sm">내가 금주를 왜 하기로 했지?</div>
        <input
          type="text"
          value={motive}
      ...
      <div
        style={{ width: `${BOX_SIZE}px`, height: BOX_SIZE }}
        className="bg-emerald-500 text-white flex justify-center items-center flex-col"
      >
        <div>{diffDay}일 참아서</div>
        <div>{totalSavingMoney.toLocaleString()}원 절약했어요!</div>
      </div>
    </div>
  );
}
