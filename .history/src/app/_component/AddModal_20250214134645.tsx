...
interface AddModalProps {
  currentDate: Date;
  closeAddModal(): void;
  handlePopupMenu(value: boolean): void;
}

export default function AddModal({ currentDate, closeAddModal, handlePopupMenu }: AddModalProps) {
  // useState
  ...
  const { addAlcoholDate } = useAddAlcoholDate(() => {
    toast(`${dayjs(currentDate).format("YYYY년 MM월 DD일")}에 추가되었습니다.`);
