          ...
          return (
            <div
              ...
              ${
                isSelectedDate(day) &&
                isSelectedMonth() &&
                "bg-blue-500 text-white hover:bg-blue-600 hover:text-black hover:rounded-full"
              } flex items-center justify-center  w-[100px] h-[100px] text-center transition-[background-color]`}
              onClick={(e) => {
                e.preventDefault();
                handleClickDate(day);
              }}
