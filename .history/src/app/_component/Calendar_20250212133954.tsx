            ...
            <div
              ...
              ${
                isSelectedDate(day) && isSelectedMonth()
                  ? isAlcohol
                    ? " text-red-300 font-bold hover:bg-blue-600"
              ...
              ${isSelectedDate(day) && isSelectedMonth() ? "bg-blue-500" : ""}
              
              flex items-center justify-center rounded-full w-[100px] h-[100px] text-center transition-[background-color,color]`}
              onClick={(e) => {
                e.preventDefault();
                handleClickDate(day);
              }}
