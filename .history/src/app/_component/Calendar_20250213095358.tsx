          ...
          return (
            ...
            >
              ...
              <div
                ...
                } font-normal text-sm absolute w-full h-full transition-[top] bg-red-200 flex justify-center items-center flex-col`}
              >
                <span>소주{hoverdDay?.soju}병</span>
                <span>맥주{hoverdDay?.beer}ml</span>
              </div>
            </div>
          );
        })}
