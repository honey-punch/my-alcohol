export default function Calendar() {
  return <div>import { FaAngleLeft, FaAngleRight, FaAnglesLeft, FaAnglesRight } from 'react-icons/fa6';
  ...
  interface CalenderProps {
    ...
    movePrevMonth(): void;
    moveNextMonth(): void;
    handleDateSelect(v: string): void;
    value: string;
    movePrevYear(): void;
    moveNextYear(): void;
  }
  ...
  export default function Calendar({
    ...
    return (
      <div
        className="w-[460px] rounded-lg border bg-white p-6 shadow-md"
        onMouseDown={(e) => {
          e.preventDefault();
        }}
      >
            ...
            return (
              <div
                ...
                className={cx(
                  ...
                  isSelectedDate(day) && isSelectedMonth() && 'bg-adams-500 text-white hover:bg-adams-600',
