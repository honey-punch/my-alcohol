  ...
  return (
    <div className="grid grid-cols-2">
      <div
        ...
        className="bg-pink-300 text-white flex justify-center items-center text-4xl"
      >
        {getDayDiff()}
      </div>
      <div
      ...
      <div
        style={{ width: `${BOX_SIZE}px`, height: BOX_SIZE }}
        className="bg-yellow-400 text-white flex justify-center items-center"
      ></div>
      <div
        style={{ width: `${BOX_SIZE}px`, height: BOX_SIZE }}
        className="bg-gray-200 text-white flex justify-center items-center"
      ></div>
      <div
        style={{ width: `${BOX_SIZE}px`, height: BOX_SIZE }}
