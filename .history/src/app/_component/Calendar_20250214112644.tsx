          ...
          return (
            <div key={key} className="relative">
              ...
              {popupMenuOpen && isSelectedMonth() && isSelectedDate(day) && (
                <ul className="absolute z-10 top-1/2 -translate-y-1/2 -right-[90px] bg-white shadow-lg rounded-lg border py-4">
                  <li className="p-4 w-20 flex items-center justify-center cursor-pointer hover:bg-gray-200">삭제</li>
                </ul>
              )}
            </div>
          );
