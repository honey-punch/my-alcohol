            ...
            <div
              ...
              ${
                isSelectedDate(day) && isSelectedMonth()
                  ? isAlcohol
                    ? "bg-blue-500 text-red-300 font-bold hover:bg-blue-600"
              ...
              flex items-center justify-center rounded-full w-[100px] h-[100px] text-center transition-[background-color,text-color]`}
              onClick={(e) => {
                e.preventDefault();
                handleClickDate(day);
              }}
