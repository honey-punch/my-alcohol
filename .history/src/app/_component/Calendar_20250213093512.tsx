        ...
        {days.map((day, i) => {
          ...
          return (
            <div
              ...
              ${isMouseEnterDay === day && "text-yellow-500"}
              
              absolute flex items-center justify-center rounded-full w-[100px] h-[100px] text-center transition-[background-color,color]`}
              onClick={(e) => {
                e.preventDefault();
                handleClickDate(day);
              }}
