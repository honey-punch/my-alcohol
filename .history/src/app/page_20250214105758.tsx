  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center p-10 gap-20 relative">
      ...
      >
        <button
          className={`${
            viewType === "summary" && "bg-blue-500 text-white group-hover:bg-gray-400 group-hover:rounded-full"
        ...
        <button
          className={`${
            viewType === "calendar" && "bg-blue-500 text-white group-hover:bg-gray-400 group-hover:rounded-full"
