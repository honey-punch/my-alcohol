...
export default function Home() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center p-10 gap-20 relative">
      <div
      ...
      <button className="bottom-0 right-0 absolute shadow-md p-4 rounded-full bg-blue-500 text-white">
        <FaPlus />
      </button>
    </div>
  );
