  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center p-10 gap-20 relative">
      ...
      <button
        ...
        className="bottom-16 right-16 absolute shadow-gray-400 shadow-lg p-4 rounded-full bg-blue-500 text-white active:shadow-none transition-all active:bottom-[62px]"
      >
        <FaPlus />
      </button>
