    ...
    <div className="w-full flex flex-col items-center p-10 gap-20 relative">
      <div onClick={handleChangeViewType} className="flex">
        <button
          ...
          } rounded-s-full border-l border-y px-8 py-4 transition-colors hover:bg-gray-200 hover:text-white`}
        >
          개요
        </button>
        <button
          ...
          } rounded-e-full border-r border-y px-8 py-4 transition-colors hover:bg-gray-200 hover:text-white`}
        >
          달력
        </button>
      </div>
