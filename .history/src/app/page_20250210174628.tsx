        ...
        <button
          className={`${
            viewType === "summary"
              ...
              : "hover:bg-blue-600"
          } rounded-s-full border-l border-y px-8 py-4 transition-colors hover:bg-blue-600`}
        >
          개요
        </button>
        <button
          className={`${
            viewType === "calendar"
              ? "bg-blue-500 text-white font-black"
              : "hover:bg-blue-600"
          } rounded-e-full border-r border-y px-8 py-4 transition-colors hover:bg-blue-600`}
        >
          달력
        </button>
      </div>
