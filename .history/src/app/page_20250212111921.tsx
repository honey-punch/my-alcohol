...
import { useDates } from "@/hooks/alcohol/alcohol";
...
export default function Home() {
  ...
  // hooks
  const { alcoholDates, isLoadingAlcoholDates } = useDates();
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center p-10 gap-20 relative">
      ...
      {viewType === "summary" ? (
        <Summary
          alcoholDates={alcoholDates || []}
          isLoadingAlcoholDates={isLoadingAlcoholDates}
        />
      ) : (
        <Calendar />
      )}
