  ...
  return (
    <div className="w-full flex flex-col items-center p-10 gap-20 relative">
      <div
        ...
        className="flex rounded-full border group"
      >
        <button
          className={`${
            viewType === "summary" && "bg-blue-500 text-white"
          } rounded-s-full px-8 py-4 transition-[background-color,border-radius] group-hover:bg-gray-200 group-hover:rounded-full`}
        >
          개요
        </button>
        <button
          ...
          } rounded-e-full px-8 py-4 transition-[background-color,border-radius] group-hover:bg-gray-200 group-hover:rounded-full`}
        >
          달력
        </button>
      </div>
